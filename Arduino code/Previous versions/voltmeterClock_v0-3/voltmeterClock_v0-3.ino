...
byte minutesVoltmeterScalePWM[] = {21, 46, 67, 94, 130, 176, 250};
...
byte hoursVoltmeterScalePWM[] = {3, 23, 37, 52, 69, 87, 111, 141, 183};
...
byte monthVoltmeterScalePWM[] = {0, 23, 49, 82, 127, 188, 255};
...
float getPositionOnScale(float scaleMin, float scaleMax, float valueOnScale) {
  ...
  //I could have used mapfloatReturnFloat(valueOnScale, scaleMin, scaleMax, 0, 1) which is a function I created which has the same task as map(), but it takes and resturns float values
...
void loop() {
  ...
  //Will re-add this feature in a later version
